...
$router->add("/r/(.*)", function($hash){
	require "pages/addResponse.php";
	return true;
});
$router->add("/prompts", function(){
	require "pages/prompts.php";
	return true;
});
$router->add("/prompt/(.*)", function($prompt_id){
	require "pages/prompt.php";
	return true;
});
$router->add("/add", function(){
	require "pages/addPrompt.php";
	return true;
});
...
$router->add('/u/(.*)/(.*)', function($profile_user, $prompt_id){
	require 'pages/profile.php';
	return true;
});
